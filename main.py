...
def print_enp4s0(
    enp4s0_bytes_sent_total,
    enp4s0_bytes_sent_sec,
    enp4s0_bytes_recv_total,
    enp4s0_bytes_recv_sec,
    enp4s0_packets_sent_total,
    enp4s0_packets_sent_sec,
    enp4s0_packets_recv_total,
    enp4s0_packets_recv_sec,
):
...
def print_lo(
    ...
    lo_bytes_recv_total,
    lo_bytes_recv_sec,
    lo_packets_sent_total,
    lo_packets_sent_sec,
    lo_packets_recv_total,
    lo_packets_recv_sec,
):
    print("=" * 40)
...
def print_wlan0(
    wlan0_bytes_sent_total,
    wlan0_bytes_sent_sec,
    wlan0_bytes_recv_total,
    wlan0_bytes_recv_sec,
    wlan0_packets_sent_total,
    wlan0_packets_sent_sec,
    wlan0_packets_recv_total,
    wlan0_packets_recv_sec,
):
    print("=" * 40)
